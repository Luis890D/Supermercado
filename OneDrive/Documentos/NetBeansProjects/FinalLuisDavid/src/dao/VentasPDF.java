...
public class VentasPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            nombreArchivoPDFVenta = "Factura " + nombreCliente + " " + fechaNueva + ".pdf";
            ...
            Image img = Image.getInstance("src/imagenes/factura.png");
            ...
            String ruc = "123456789101112";
            String nombre = "Super Mercados La Torre";
            String telefono = "4541-6036";
            String direccion = "Guastatoya";
            String razon = "Gracias por su compa";

            Encabezado.addCell("");//celda vacia
            Encabezado.addCell("Número de factura: " + ruc + "\nNOMBRE: " + nombre + "\nTELEFONO: " + telefono + "\nDIRECCION: " + direccion + "\nRAZON SOCIAL: " + razon);
            ...
            for (int i = 0; i < Vender.JTableTotal.getRowCount(); i++) {
                String producto = Vender.JTableTotal.getValueAt(i, 1).toString();
                String cantidad = Vender.JTableTotal.getValueAt(i, 2).toString();
                String precio = Vender.JTableTotal.getValueAt(i, 3).toString();
                String total = Vender.JTableTotal.getValueAt(i, 7).toString();
            ...
            info.add("Total a pagar: " + Vender.txtTOTAL.getText());
